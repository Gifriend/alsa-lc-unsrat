  ...
  return (
    <main>
      ...
      <section className="section-spacing container-custom">
        <h1 className="mb-12">Program Kerja (Proker)</h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-neutral-medium">No program kerja found.</div>
        ) : (
            ...
            {filteredProkers.map((proker) => (
              ...
              >
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-serif text-xl font-bold text-primary">{proker.title}</h3>
                  <span
                    className={`px-3 py-1 rounded text-sm font-semibold capitalize ${
                      proker.status === "ongoing" ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"
                    }`}
                  >
                    {proker.status}
                  </span>
