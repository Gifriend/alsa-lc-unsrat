  ...
  return (
    <div>
        ...
        <div className="bg-white p-6 rounded shadow mb-6 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              {isProcessing ? "Processing..." : isLoading ? "Saving..." : "Save Item"}
            </button>
          </form>
        </div>
      )}
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 bg-white rounded text-neutral-medium border border-gray-100">No merchandise added yet.</div>
      ) : (
        <div className="space-y-3">
          {merchandise.map((item) => (
            <div key={item.id} className="bg-white p-4 rounded shadow-sm border border-gray-100 flex justify-between items-start gap-4">
              ...
              <div className="flex gap-2">
                <button onClick={() => handleEdit(item)} className="p-2 text-accent hover:bg-accent/10 rounded transition-colors">
                  <Edit2 size={18} />
                </button>
